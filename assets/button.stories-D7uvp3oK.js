import{j as r}from"./jsx-runtime-BZf_YgVj.js";import{s as C,d as i}from"./storybook-b3FPHv77.js";import{B as c,v as B,s as b}from"./button-CQWMumY8.js";import{I as j}from"./icon-DxR5d0Rk.js";import"./index-CEThVCg_.js";import"./entry-preview-D6uH2-Qp.js";import"./react-18-__cZF4IP.js";import"./index-DRe9y7bH.js";import"./modes-CfxMDJKC.js";import"./index-MeWECQMo.js";import"./misc-Bk0sxs-g.js";import"./index-Bb4qSo10.js";const P={title:"⚛️ Atoms/Button",component:c,parameters:{layout:"centered",...C("https://www.figma.com/file/zx5FkmiDiV7F8Jn5phnpeJ/Ence-Pence-Huta-v2?node-id=20-76&t=SgllQF4sLHtxY4V0-4")},args:{children:"Click me",variant:"default",size:"default"},argTypes:{variant:{options:B,control:{type:"radio"}},size:{options:b,control:{type:"radio"}},...i(["asChild"])},tags:["autodocs"]},s={args:{variant:"default"}},n={args:{variant:"outline",size:"icon",children:r.jsx(j,{name:"baby-shoes"})},argTypes:{...i(["size","children","variant"])}},t={render:a=>r.jsx("div",{className:"flex gap-4",children:B.map(e=>r.jsx(c,{...a,variant:e},e))}),argTypes:{...i(["variant"])}},o={render:a=>r.jsx("div",{className:"flex gap-4",children:b.map(e=>r.jsx(c,{...a,size:e,children:e==="icon"?null:a.children},e))}),argTypes:{...i(["size"])}};var p,m,d;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    variant: 'default'
  }
}`,...(d=(m=s.parameters)==null?void 0:m.docs)==null?void 0:d.source}}};var l,u,g;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    variant: 'outline',
    size: 'icon',
